/**
 * Automated Database Schema & Seed Initializer (Backend Utility)
...
async function setupDatabase() {
  ...
  try {
    ...
    // Read schema file (located in ../../../database/schema.sql relative to backend/src/utils/)
    ...
    // Read seed file (located in ../../../database/seed.sql)
